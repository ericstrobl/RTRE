...
for (i in 156:1000){
  ...
  print("A")
  ptm <- proc.time()
  shaps = do_reg(datan,DAGn,Yi,exc=c(6,7)) ##
  ...
  print("E")
  ptm <- proc.time()
  shaps = ISVnInt4(datan,DAGn,Yi,exc=c(6,7)) ##
  ...
  print("L")
  ptm <- proc.time()
  shaps = do_SVn2(datan,DAGn,Yi,exc=c(6,7)) ##
  ...
  save(file="Results_real_diabetes.RData",Gs,do_reg_res,marginal_SV_res,conditional_SV_res,
